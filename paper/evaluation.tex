...
\textcolor{red}{As evidence for this, we sometimes observed cases when bug reporters responded negatively to the posed follow-up questions, e.g., answering “why is that relevant” (https://github.com/mautic/mautic/issues/1550).} More importantly, several of
