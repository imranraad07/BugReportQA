...
Through personal contacts, we e-mailed 8 software developers about the survey, providing the basic context of our project, a link to a Web form containing the survey and the expected time span of the survey (30 minutes). None of the developers were
aware about the details of our technique. The developers were half from academia (graduate students at
...
were the top-1 recommended by \evpi. We selected bug reports from our corpus to belong to GitHub projects where Java or Python were
the primary technologies used, without any additional filtering to avoid bias. For each one of the 12 bug reports, a developer
was presented with a screenshot from GitHub containing the title and text of the bug report, the follow-up question, and a link to the project the bug report came from. The developers were asked to read both the bug report and the follow-up question before answering the provided set of survey questions. The first preliminary survey question, which was posed on a separate screen, asked "Is the follow-up question valid?". A negative response indicated that the follow-up question was invalid and unusable, so, therefore we asked no additional survey questions for that bug report. The remaining survey questions only appeared for follow-up questions deemed valid by a developer.
