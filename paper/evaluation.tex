...
&           & Wilcoxon & effect &           & Wilcoxon & effect &           & Wilcoxon & effect &           & Wilcoxon & effect \\
& {\bf MRR} & p-value  & size   & {\bf P@1} & p-value  & size   & {\bf P@3} & p-value  & size   & {\bf P@5} & p-value  & size \\ \hline
...
{\em \evpi}               & {\bf 0.67} & & & 0.49 & & & 0.49 & & & 0.45 & &  \\ \hline
\end{tabular}
\label{tab:results}
\end{table*}
