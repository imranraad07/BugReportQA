...
as valid with an inter-annotator agreement (Cohen's kappa) of X. We use the set of follow-up questions that both annotators agreed were valid, i.e., the intersection between their annotation.
...
baselines in Table~\ref{tab:results}.
