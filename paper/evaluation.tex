...
To further illustrate \evpi's performance, we contrast the \evpi follow-up questions to the ones posed in the original bug report for three of the highest rated survey instances in Table~\ref{tab:survey}. While for one of the instances, FQ22, the recommended follow-up question matches the posed follow-up question, which is possible since the original follow-up question is in our candidate set, the remaining two follow-up questions are different. \evpi's follow-up question in FQ9 is specific to {\em numpy}, which is a library mentioned in the bug report, while FQ14 asks the more generic, but appropriate, question of {\em Can you describe your scenario a little more?}.
