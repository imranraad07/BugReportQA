...
in projects on GitHub, which is why we opted to include unlabeled issues. Since we are interested in deficient bug reports, we selected bug reports that do not contain \textcolor{red}{any} Observable Behavior, Expected Behavior, \textcolor{red}{or} Steps to Reproduce.
...
\begin{figure}[t]
\centering
\includegraphics[width=0.95\linewidth]{figures/compat_nn.pdf}
