...
matching between questions and we reserve 10 of the most similar question variants for each queried follow-up question. The intuition is that by computing the average amount of OB/EB/S2R we smooth across individual follow-up questions to determine if the question have value
across all of its occurrences in the corpus.
