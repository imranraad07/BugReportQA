...
We found that follow-up questions were present in 24\% (122/500) of bug reports and about half (52\% or 63/122) of them were
answered with 55\% (35/63) of the answers containing Observable Behavior, Expected Behavior or Steps to Reproduce.

We highlight one of the bug reports we examined in Figure~\ref{fig:bug_report}. The follow-up question {\em What OS/version of
Ansible was this on?} elicits an answer that provides key OB to the bug triagers, leading to a quick subsequent
bug fix.
