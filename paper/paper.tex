...
%
To estimate the best follow-up question for a specific deficient bug report we combine two metrics: 1) the compatibility of a follow-up question to a specific bug report; and 2) the utility the expected answer to the follow-up question would provide to the deficient bug report.
%
